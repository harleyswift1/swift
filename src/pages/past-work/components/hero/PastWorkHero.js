...
export default function PastWorkHero() {
    return <div className="content-container hero">
        <div className="hero__content">
            <h1>My previous transformations</h1>
            <p>We've changed business forever - getting them more conversions, interactions, and customers. Take a look at some we've done in the past</p>
            <br/>
